        ...
        if (!skip) {
          ...
          switch (cast_size) {
            ...
            case 8:
              ...
              // outs() << IRB.CreateCall(cmplogHookIns1, args);
              // outs() << "\n";
              IRB.CreateCall(cmplogHookIns1, args);
              break;
            case 16:
              // outs() << IRB.CreateCall(cmplogHookIns2, args);
              // outs() << "\n";
              IRB.CreateCall(cmplogHookIns2, args);
              break;
            case 32:
              // outs() << IRB.CreateCall(cmplogHookIns4, args);
              // outs() << "\n";
              IRB.CreateCall(cmplogHookIns4, args);
              break;
            case 64:
              // outs() << IRB.CreateCall(cmplogHookIns8, args);
              // outs() << "\n";
            ...
            case 128:
              if (max_size == 128) {
                ...
                // outs() << IRB.CreateCall(cmplogHookIns16, args);
                // outs() << "\n";
                IRB.CreateCall(cmplogHookIns16, args);

              } else {

                // outs() << IRB.CreateCall(cmplogHookInsN, args);
                // outs() << "\n";
